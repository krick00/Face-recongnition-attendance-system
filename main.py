...
img1 = face_recognition.load_image_file(r'images\dhoni.jpg')
img1 = cv2.cvtColor(img1, cv2.COLOR_BGR2RGB)
img1Test = face_recognition.load_image_file(r'images\dhoni2.jpg')
...
cv2.imshow('Dhoni', img1)
cv2.imshow('Dhoni Test', img1Test)
cv2.waitKey(0)
